...
class Profile extends Component {
    ...
    componentDidMount() {
        ...
        // console.log("in did")
        // console.log("token",JSON.parse(localStorage.token)['username'])
        console.log("this.props.reg in did",this.props.regs)
        // console.log("-----------------------------------------------------------")
        // }
        // else{
        //     window.location.href="/login"
        ...
        componentDidUpdate(){
            console.log("inn",this.props.regs)
    ...
    componentWillMount(){
        ...
        console.log("componenrhjgdsfhskjdfhjks")   
            
        this.props.fetchProfile();
        console.log("this.props.reg in will",this.props.regs)
    }
    else{
        if(true){
            <Redirect to="/login" /> 
...
const mapStateToProps = (store) => {
    ...
    return {
    //   regs: store.loginAttempts.fetching,
    }
  }
*/
  export default connect(mapStateToProps,mapDispatchToProps)(Profile);
